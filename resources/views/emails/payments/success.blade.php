                ...
                <tr>
                    <td class="content-cell"
                        ...
                        <div class="f-fallback">
                            ...
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Your
                                appointment has been booked successfully. Go to the Get appointment endpoint to view the
                                appointments you have paid for <br><br><br><br><br>Thanks for choosing us.
                            </p>
                            <!-- Action -->
