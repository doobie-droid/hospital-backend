                ...
                <tr>
                    <td class="content-cell"
                        ...
                        <div class="f-fallback">
                            ...
                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Sorry,
                                we could not process your transaction, Please try again later.<br><br><br><br><br>Thanks for
                                choosing us.
                            </p>
                            <!-- Action -->
